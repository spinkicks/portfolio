/*
  "Inside the Matrix" by And390 - https://www.shadertoy.com/view/4t3BWl
  ...
  Local change: the iteration count is a macro so the host can trade march depth
  for frame time. Everything else is the original.
*/

#ifndef RAIN_ITERATIONS
#define RAIN_ITERATIONS 40
#endif

const int ITERATIONS = RAIN_ITERATIONS;   //use less value if you need more performance
const float SPEED = 1.;
